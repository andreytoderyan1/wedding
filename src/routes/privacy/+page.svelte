	...
	<section class="py-12 sm:py-16 lg:py-20">
		<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
			<div class="prose prose-lg max-w-none">
				...
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">What Personally Identifiable Information is collected?</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					We may collect basic user profile information from all of our Visitors. We collect the following additional information from our Authorized Customers: the names, addresses, phone numbers and email addresses of Authorized Customers, the nature and size of the business, and the nature and size of the advertising inventory that the Authorized Customer intends to purchase or sell.
				</p>
  
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">What organizations are collecting the information?</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
				...
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">With whom may the information may be shared?</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
				...
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Are Cookies Used on {title} ?</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
				...
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					We provide Visitors and Authorized Customers with a mechanism to delete/deactivate Personally Identifiable Information from {title} 's database by contacting us. However, because of backups and records of deletions, it may be impossible to delete a Visitor's entry without retaining some residual information. An individual who requests to have Personally Identifiable Information deactivated will have this information functionally deleted, and we will not sell, transfer, or use Personally Identifiable Information relating to that individual in any way moving forward.
				</p>
  
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">What happens if the Privacy Policy Changes?</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					We will let our Visitors and Authorized Customers know about changes to our privacy policy by posting such changes on {title} . However, if we are changing our privacy policy in a manner that might cause disclosure of Personally Identifiable Information that a Visitor or Authorized Customer has previously requested not be disclosed, we will contact such Visitor or Authorized Customer to allow such Visitor or Authorized Customer to prevent such disclosure.
				</p>
