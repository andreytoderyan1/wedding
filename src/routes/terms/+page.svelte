	...
	<section class="py-12 sm:py-16 lg:py-20">
		<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
			<div class="prose prose-lg max-w-none">
				...
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					BY VIEWING, VISITING, USING, OR INTERACTING WITH {link} OR WITH ANY BANNER, POP-UP, OR ADVERTISING THAT APPEARS ON IT, YOU ARE AGREEING TO ALL THE PROVISIONS OF THIS TERMS OF USE POLICY AND THE PRIVACY POLICY OF {link}.
				</p>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					ALL PERSONS UNDER THE AGE OF 18 ARE DENIED ACCESS TO {link}. IF YOU ARE UNDER 18 YEARS OF AGE, IT IS UNLAWFUL FOR YOU TO VISIT, READ, OR INTERACT WITH {link} OR ITS CONTENTS IN ANY MANNER. {link} SPECIFICALLY DENIES ACCESS TO ANY INDIVIDUAL THAT IS COVERED BY THE CHILD ONLINE PRIVACY ACT (COPA) OF 1998.
				</p>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					{link} RESERVES THE RIGHT TO DENY ACCESS TO ANY PERSON OR VIEWER FOR ANY REASON. UNDER THE TERMS OF THE PRIVACY POLICY, WHICH YOU ACCEPT AS A CONDITION FOR VIEWING, {link} IS ALLOWED TO COLLECT AND STORE DATA AND INFORMATION FOR THE PURPOSE OF EXCLUSION AND FOR MANY OTHER USES.
				</p>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					THE TERMS OF USE AGREEMENT MAY CHANGE FROM TIME TO TIME. VISITORS HAVE AN AFFIRMATIVE DUTY, AS PART OF THE CONSIDERATION FOR PERMISSION TO VIEW {link}, TO KEEP THEMSELVES INFORMED OF CHANGES.
				</p>
    
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Parties to the Terms of Use Agreement</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					Visitors, viewers, users, subscribers, members, affiliates, or customers, collectively referred to herein as "Visitors," are parties to this agreement. The website and its owners and/or operators are parties to this agreement, herein referred to as "Website."
				</p>
    
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Use of Information From This Website</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
				...
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Ownership of Website or Right to Use, Sell, Publish Contents of This Website</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					The website and its contents are owned or licensed by the website. Material contained on the website must be presumed to be proprietary and copyrighted. Visitors have no rights whatsoever in the site content. Use of website content for any reason is unlawful unless it is done with express contract or permission of the website.
				</p>
    
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Hyperlinking to Site, Co-Branding, "Framing" and Referencing Site Prohibited</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
				...
				<h2 class="mt-8 mb-4 text-2xl font-semibold text-gray-900">Contact Information</h2>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
					{link}
				</p>
				<p class="mb-6 text-base leading-relaxed text-gray-700">
